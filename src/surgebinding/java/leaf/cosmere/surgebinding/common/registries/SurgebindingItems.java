...
public class SurgebindingItems
{
	...
	public static final ItemRegistryObject<DeadplateItem> DEADPLATE_HELMET = ITEMS.register("deadplate_helmet", () -> new DeadplateItem(ShardplateArmorMaterial.DEADPLATE, ArmorItem.Type.HELMET, PropTypes.Items.SHARDBLADE.get()));
	public static final ItemRegistryObject<DeadplateItem> DEADPLATE_CHEST = ITEMS.register("deadplate_chest", () -> new DeadplateItem(ShardplateArmorMaterial.DEADPLATE, ArmorItem.Type.CHESTPLATE, PropTypes.Items.SHARDBLADE.get()));
	public static final ItemRegistryObject<DeadplateItem> DEADPLATE_LEGGINGS = ITEMS.register("deadplate_leggings", () -> new DeadplateItem(ShardplateArmorMaterial.DEADPLATE, ArmorItem.Type.LEGGINGS, PropTypes.Items.SHARDBLADE.get()));
	public static final ItemRegistryObject<DeadplateItem> DEADPLATE_BOOTS = ITEMS.register("deadplate_boots", () -> new DeadplateItem(ShardplateArmorMaterial.DEADPLATE, ArmorItem.Type.BOOTS, PropTypes.Items.SHARDBLADE.get()));
	...
	public static final Map<Roshar.RadiantOrder, Map<ArmorItem.Type, ItemRegistryObject<LivingplateItem>>> SHARDPLATES =
			Arrays.stream(EnumUtils.RADIANT_ORDERS)
					.collect(Collectors.toMap(
							Function.identity(),
							order -> Map.of(
									ArmorItem.Type.HELMET,
									ITEMS.register(order.getName() + "_shardplate_helmet",
										() -> new LivingplateItem(ShardplateArmorMaterial.LIVINGPLATE,
																	ArmorItem.Type.HELMET,
																	PropTypes.Items.SHARDBLADE.get(),
																	order
										)
									),
									ArmorItem.Type.CHESTPLATE,
									ITEMS.register(order.getName() + "_shardplate_chest",
										() -> new LivingplateItem(ShardplateArmorMaterial.LIVINGPLATE,
																	ArmorItem.Type.CHESTPLATE,
																	PropTypes.Items.SHARDBLADE.get(),
                                                                    order
									...
									ITEMS.register(order.getName() + "_shardplate_leggings",
										() -> new LivingplateItem(ShardplateArmorMaterial.LIVINGPLATE,
																	ArmorItem.Type.LEGGINGS,
																	PropTypes.Items.SHARDBLADE.get(),
																	order
									)),
									LivingplateItem.Type.BOOTS,
									ITEMS.register(order.getName() + "_shardplate_boots",
										() -> new LivingplateItem(ShardplateArmorMaterial.LIVINGPLATE,
																	LivingplateItem.Type.BOOTS,
																	PropTypes.Items.SHARDBLADE.get(),
                                                                    order
