...
public class DynamicShardplateModel extends HumanoidModel<LivingEntity>
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition faceplate = head.addOrReplaceChild("faceplate", CubeListBuilder.create(), PartPose.offset(0.0F, -9.2F, -2.2F));

		PartDefinition faceplate1 = faceplate.addOrReplaceChild("faceplate1", CubeListBuilder.create().texOffs(87, 87).addBox(-4.0F, 1.35F, -0.5F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.6F))
				.texOffs(96, 77).addBox(-2.0F, 1.35F, -1.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, -0.55F, -0.3F));

		PartDefinition cube_r1 = faceplate1.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(96, 67).mirror().addBox(1.4F, -7.65F, 0.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)).mirror(false), PartPose.offsetAndRotation(-5.0F, 9.0F, -0.5F, 0.0F, 0.5672F, 0.0F));

		PartDefinition cube_r2 = faceplate1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(86, 77).addBox(-5.4F, -7.65F, 0.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)), PartPose.offsetAndRotation(5.0F, 9.0F, -0.5F, 0.0F, -0.5672F, 0.0F));

		PartDefinition faceplate2 = faceplate.addOrReplaceChild("faceplate2", CubeListBuilder.create().texOffs(108, 85).addBox(-4.0F, 1.35F, -0.5F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.6F))
				.texOffs(116, 75).addBox(-2.0F, 1.35F, -1.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, -0.55F, -0.3F));

		PartDefinition cube_r3 = faceplate2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(106, 75).mirror().addBox(1.4F, -7.65F, 0.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)).mirror(false), PartPose.offsetAndRotation(-5.0F, 9.0F, -0.5F, 0.0F, 0.5672F, 0.0F));

		PartDefinition cube_r4 = faceplate2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(116, 65).addBox(-5.4F, -7.65F, 0.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)), PartPose.offsetAndRotation(5.0F, 9.0F, -0.5F, 0.0F, -0.5672F, 0.0F));

		PartDefinition faceplate3 = faceplate.addOrReplaceChild("faceplate3", CubeListBuilder.create().texOffs(87, 117).addBox(-4.0F, 1.35F, -0.5F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.6F))
				.texOffs(95, 107).addBox(-2.0F, 1.35F, -1.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, -0.55F, -0.3F));

		PartDefinition cube_r5 = faceplate3.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(85, 107).mirror().addBox(1.4F, -7.65F, 0.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)).mirror(false), PartPose.offsetAndRotation(-5.0F, 9.0F, -0.5F, 0.0F, 0.5672F, 0.0F));

		PartDefinition cube_r6 = faceplate3.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(95, 97).addBox(-5.4F, -7.65F, 0.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)), PartPose.offsetAndRotation(5.0F, 9.0F, -0.5F, 0.0F, -0.5672F, 0.0F));

		PartDefinition faceplate4 = faceplate.addOrReplaceChild("faceplate4", CubeListBuilder.create().texOffs(108, 117).addBox(-4.0F, 1.35F, -0.5F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.6F))
				.texOffs(116, 107).addBox(-2.0F, 1.35F, -1.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, -0.55F, -0.3F));

		PartDefinition cube_r7 = faceplate4.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(116, 97).mirror().addBox(1.4F, -7.65F, 0.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)).mirror(false), PartPose.offsetAndRotation(-5.0F, 9.0F, -0.5F, 0.0F, 0.5672F, 0.0F));

		PartDefinition cube_r8 = faceplate4.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(106, 107).addBox(-5.4F, -7.65F, 0.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.6F)), PartPose.offsetAndRotation(5.0F, 9.0F, -0.5F, 0.0F, -0.5672F, 0.0F));
		...
		PartDefinition right_armmain1 = right_arm_main.addOrReplaceChild("right_armmain1", CubeListBuilder.create().texOffs(2, 84).addBox(-0.9375F, -1.7947F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offset(-2.5625F, 0.5447F, 0.0F));
		...
		PartDefinition right_arm_r1 = right_paldron1.addOrReplaceChild("right_arm_r1", CubeListBuilder.create().texOffs(1, 56).addBox(0.0625F, 2.2811F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.138F));

		PartDefinition right_arm_r2 = right_paldron1.addOrReplaceChild("right_arm_r2", CubeListBuilder.create().texOffs(13, 58).addBox(0.0625F, -1.5268F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2182F));

		PartDefinition right_arm_r3 = right_paldron1.addOrReplaceChild("right_arm_r3", CubeListBuilder.create().texOffs(10, 65).addBox(2.0625F, -2.4945F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.7F))
				.texOffs(1, 64).addBox(0.0625F, -2.9749F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));
		...
		PartDefinition left_armmain1 = left_arm_main.addOrReplaceChild("left_armmain1", CubeListBuilder.create().texOffs(64, 85).addBox(-3.0625F, -1.7947F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offset(2.5625F, 0.5447F, 0.0F));
		...
		PartDefinition left_arm_r1 = left_paldron1.addOrReplaceChild("left_arm_r1", CubeListBuilder.create().texOffs(54, 54).addBox(-2.0625F, 2.4154F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.138F));

		PartDefinition left_arm_r2 = left_paldron1.addOrReplaceChild("left_arm_r2", CubeListBuilder.create().texOffs(54, 63).addBox(-2.0625F, -1.7709F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2182F));

		PartDefinition left_arm_r3 = left_paldron1.addOrReplaceChild("left_arm_r3", CubeListBuilder.create().texOffs(66, 57).addBox(-2.0625F, -3.1797F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.7F))
				.texOffs(64, 65).addBox(-0.0625F, -2.6993F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.7F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));
