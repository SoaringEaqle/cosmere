...
//modified copy of Mekanisms ResizableOreFeature
// https://github.com/mekanism/Mekanism/blob/7de496745c721fb15d00d590ddcacf00570f3f1b/src/main/java/mekanism/common/world/ResizableOreFeature.java#L20
...
public class ResizableOreFeature extends Feature<ResizableOreFeatureConfig>
{
	...
	public boolean place(@NotNull FeaturePlaceContext<ResizableOreFeatureConfig> context)
	{
		...
		float adjustedSize = config.size().get() / 8.0F;
	                          ...
	                          double yMax, int minXStart, int minYStart, int minZStart, int width, int height)
	{
		...
		{
			double discardChanceOnAirExposure = config.discardChanceOnAirExposure().get();
	...
	private static boolean canPlaceOre(BlockState state, Function<BlockPos, BlockState> adjacentStateAccessor, RandomSource random, double discardChanceOnAirExposure,
